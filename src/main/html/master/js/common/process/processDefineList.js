...
function updProcess(data){
    ...
    parent.indexModel.addTab("修改流程信息","/view/common/process/processView.html?operType=update&processId="+data.processId);
}
...
(function(){
    ...
    function initEvent(){
        ...
        $("#newProcess").bind("click",function(){//新增按钮添加事件
            // parent.indexModel.addTab("新建流程","/view/common/process/processView.html?operType=new");
            window.open("/view/common/process/processView.html?operType=new","新建流程");
        });
        ...
        $("#processGrid").datagrid().dbclick(function(data,element){
            ...
            parent.indexModel.addTab("查看流程信息","/view/common/process/processView.html?operType=view&processId="+data.processId);
        });
    }
    init();
})();