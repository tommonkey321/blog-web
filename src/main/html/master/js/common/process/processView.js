(function(){
    ...
    function initUI(){
        ...
        $.extend(true,process.config.props.props,{
            ...
            processParam : {name:'processParam',label:"流程参数",value:'',editor: function(){return new process.editors.windowEditor({isEdit:isEdit,title:"流程参数",url:PROJECT_URL+"/view/common/process/processParam.html",showText:"text",key:"paramCode"});}}
        ...
        $.extend(true,process.config.tools.states,{
            ...
            task : {type : 'task',
                ...
                props : {
                    ...
                    taskParam: {name:'taskParam', label: '任务参数', value:'', editor: function(){return new process.editors.windowEditor({isEdit:isEdit,title:"任务参数",url:PROJECT_URL+"/view/common/process/processParam.html",showText:"text",key:"paramCode"});}},
                    taskDealPerson: {name:'taskDealPerson', label: '任务处理人 *', value:'', editor: function(){return new process.editors.windowEditor({isEdit:isEdit,title:"任务处理人",url:PROJECT_URL+"/view/common/process/taskHandler.html",showText:"text",key:"text"});}}
                }},
