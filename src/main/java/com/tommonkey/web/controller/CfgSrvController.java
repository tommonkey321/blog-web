...
import com.tommonkey.utils.api.osdi.ICfgSrvFSV;
...
import com.tommonkey.web.util.ClassUtil;
import com.tommonkey.web.util.ResourceCollection;
...
public class CfgSrvController {
    ...
    public Map<String, String> save(@RequestParam(value = "_class", required = true) String _class,
        ...
        try {
            ...
            cfgSrvBase.setSrvPackage("com.tommonkey.utils.api.osdi.ICfgSrvFSV");
